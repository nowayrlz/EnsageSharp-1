...
namespace ChallengeAccepted
{
    class ChallengeAccepted
    {
        ...
        {
            blink = me.FindItem("imba_blink");
            armlet = me.FindItem("imba_armlet");
            blademail = me.FindItem("imba_blade_mail");
            bkb = me.FindItem("imba_black_king_bar");
            abyssal = me.FindItem("imba_abyssal_blade");
            mjollnir = me.FindItem("imba_mjollnir");
            halberd = me.FindItem("imba_heavens_halberd");
            medallion = me.FindItem("imba_medallion_of_courage");
            madness = me.FindItem("imba_mask_of_madness");
            urn = me.FindItem("imba_urn_of_shadows");
            satanic = me.FindItem("imba_satanic");
            solar = me.FindItem("imba_solar_crest");
            dust = me.FindItem("imba_dust");
            sentry = me.FindItem("imba_ward_sentry");
            mango = me.FindItem("imba_enchanted_mango");
            arcane = me.FindItem("imba_arcane_boots");
            buckler = me.FindItem("imba_buckler");
            crimson = me.FindItem("imba_crimson_guard");
            lotusorb = me.FindItem("imba_lotus_orb");
            cheese = me.FindItem("imba_cheese");
            magistick = me.FindItem("imba_magic_stick");
            magicwand = me.FindItem("imba_magic_wand");
            soulring = me.FindItem("imba_soul_ring");
            force = me.FindItem("imba_force_staff");
            cyclone = me.FindItem("imba_cyclone");
            vyse = me.FindItem("imba_sheepstick");
            atos = me.FindItem("imba_rod_of_atos");
