...
namespace ChallengeAccepted
{
    class ChallengeAccepted
    {
        ...
        {
            blink = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_blink"));
            armlet = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_armlet"));
            blademail = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_blade_mail"));
            bkb = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_black_king_bar"));
            abyssal = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_abyssal_blade"));
            mjollnir = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_mjollnir"));
            halberd = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_heavens_halberd"));
            medallion = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_medallion_of_courage"));
            madness = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_mask_of_madness"));
            urn = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_urn_of_shadows"));
            satanic = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_satanic"));
            solar = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_solar_crest"));
            dust = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_dust"));
            sentry = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_ward_sentry"));
            mango = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_enchanted_mango"));
            arcane = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_arcane_boots"));
            buckler = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_buckler"));
            crimson = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_crimson_guard"));
            lotusorb = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_lotus_orb"));
            cheese = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_cheese"));
            magistick = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_magic_stick"));
            magicwand = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_magic_wand"));
            soulring = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_soul_ring"));
            force = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_force_staff"));
            cyclone = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_cyclone"));
            vyse = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_sheepstick"));
            atos = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_rod_of_atos"));
            difusal = me.Inventory.Items.FirstOrDefault(item => item.Name.Contains("imba_diffusal_blade"));
